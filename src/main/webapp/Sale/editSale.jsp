...
<html>
    ...
    <body>
        <div id="page">
            <div class="header">
                <a href="#menu" class="contacts"></a><span>赫尔斯训练管理系统 编辑销售记录</span>
            </div>
            <div>

                <form:form action="${pageContext.request.contextPath}/Sale/submitSaleRecord" method="POST" class="mlogin" name="userForm">
                ...
                <div data-role="main" class="ui-content">
                    <input type="submit" rel="external" data-inline="true" class="ui-btn ui-btn-inline ui-shadow" value="提交">
                    <input type="submit" rel="external" data-inline="true" class="ui-btn ui-btn-inline ui-shadow" value="提交并增加销售记录">
                </div>	
            </form:form>		
        </div>
